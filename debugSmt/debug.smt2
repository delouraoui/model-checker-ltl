...
(and (= p0 0)
   (or (and (= z1p 0) (= z1t 0) (= q0 0)) (and (= z1p 0) (= z1t 0) (= q0 1))
       (and (= z1p 1) (= z1t 1) (= q0 1)) false)

       (=> (and (< 1 z0t) (= z1t 0)) (= p1 (+ p0 1))
       (=> (and (< 1 z0t) (= z1t 1) (= z1p 0)) (= p1 (+ p0 (* z1it 1) ))

       (=> (and (< 2 z0t) (= z2t 0)) (= p2 (+ p1 1))
       (=> (and (< 2 z0t) (= z2t 1) (= z2p 0)) (= p2 (+ p1 (* z2it 1) ))
       
       (=> (and (< 3 z0t) (= z3t 0)) (= p3 (+ p2 1))
       (=> (and (< 3 z0t) (= z3t 1) (= z3p 0)) (= p3 (+ p2 (* z3it 1) ))
)
...
(and
(=> (and  (<= 0 z0p) (= p p0))
	    (or (and (= z1t 0) (= z1p 0) (= q 0)) (and (= z1t 1) (= z1p 0) (= q 1))
	    (and (= z1t 0) (= z1p 1) (= q 1)) false)
	)
(=> (and  (<= 1 z0p) (= p p1))
	    (or (and (= z2t 0) (= z2p 0) (= q 0)) (and (= z2t 1) (= z2p 0) (= q 1))
	    (and (= z2t 0) (= z2p 1) (= q 1)) false)
	)
(=> (and  (<= 2 z0p) (= p p2))
	    (or (and (= z3t 0) (= z3p 0) (= q 0)) (and (= z3t 1) (= z3p 0) (= q 1))
	    (and (= z3t 0) (= z3p 1) (= q 1)) false)
	)	
(=> (and (or (and (<= 0 z0p) (< p0 p) (< p p1)) (and (= 0 z0t) (< p0 p))) (= z1t 1))
    (and (= z1p 0) (= (- p p0) (mod 1 1)) (= q 1))
)
(=> (and (or (and (<= 1 z0p) (< p1 p) (< p p2)) (and (= 1 z0t) (< p1 p))) (= z2t 1))
    (and (= z2p 0) (= (- p p1) (mod 1 1)) (= q 1))
)
(=> (and (or (and (<= 2 z0p) (< p2 p) (< p p3)) (and (= 2 z0t) (< p2 p))) (= z3t 1))
    (and (= z3p 0) (= (- p p2) (mod 1 1)) (= q 1))
)
)



exemple 1 X a et le modele 6
